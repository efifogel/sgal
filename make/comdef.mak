...
CPPOPTS =$(LCPPOPTS) $(GCPPOPTS) $(CPPWARNINGOPTS)
CPPFLAGS =$(CPPINCS) $(CPPOPTS) $(CPPDEFS)
CPPF =$(CPP) $(CPPFLAGS)

MAKEDEPEND_CPPDEFS=$(CPPDEFS)
MAKEDEPEND_CPPINCS=$(CPPINCS)
MAKEDEPEND_CPPOPTS=$(LCPPOPTS) $(GCPPOPTS) # Without the CPPWARNINGOPTS

MAKEDEPEND_CDEFS=$(CDEFS)
MAKEDEPEND_CINCS=$(CINCS)
MAKEDEPEND_COPTS=$(COPTS)

MAKEDEPEND_ASMDEFS=$(ASMDEFS)
MAKEDEPEND_ASMINCS=$(ASMINCS)
MAKEDEPEND_ASMOPTS=$(ASMOPTS)
...
TARGET = $(TARGET0) $(TARGET1) $(TARGET2) $(TARGET3) $(TARGET4) $(TARGET5) $(TARGET6) $(TARGET7)

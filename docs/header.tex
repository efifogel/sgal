...
\newcommand{\threedSystems}{{\sc 3D Systems}}
\newcommand{\lux}{{\sc Lux}}
\newcommand{\wohlers}{{\sc Wohlers Associates}}
\newcommand{\gartner}{{\sc Gartner}}
\newcommand{\technavio}{{\sc TechNavio}}
\newcommand{\sgi}{{\sc SGI}}
\newcommand{\lucid}{{\sc LucidLogix}}
\newcommand{\enbaya}{{\sc Enbaya}}
\newcommand{\tecnomatix}{{\sc Tecnomatix}}

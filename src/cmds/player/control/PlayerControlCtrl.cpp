...
BOOL CPlayerControlCtrl::CPlayerControlCtrlFactory::UpdateRegistry(BOOL bRegister)
{
...
: _bPlay(false), _tim_number(0), m_start_tick_time(0), m_sim_time(0), m_est_tick_duration(0), 
...
void CPlayerControlCtrl::OnDraw(
...
BOOL CPlayerControlCtrl::OnWndMsg(UINT message, WPARAM wParam, LPARAM lParam, LRESULT* pResult)
{

========================================================================
    ACTIVEX CONTROL DLL : PlayerControl Project Overview
========================================================================

ControlWizard has created this project for your PlayerControl ActiveX Control
...
that make up your PlayerControl ActiveX Control DLL.

PlayerControl.vcproj
...
PlayerControl.ico
    ...
    is included by the main resource file PlayerControl.rc.

/////////////////////////////////////////////////////////////////////////////
CPlayerControlCtrl control:

PlayerControlCtrl.h
    This file contains the declaration of the CPlayerControlCtrl C++ class.

PlayerControlCtrl.cpp
    This file contains the implementation of the CPlayerControlCtrl C++ class.

PlayerControlPropPage.h
    This file contains the declaration of the CPlayerControlPropPage C++ class.

PlayerControlPropPage.cpp
    This file contains the implementation of the CPlayerControlPropPage C++ class.

CPlayerControlCtrl.bmp
    This file contains a bitmap that a container will use to represent the
    CPlayerControlCtrl control when it appears on a tool palette.  This bitmap
    is included by the main resource file PlayerControl.rc.
...
stdafx.h, stdafx.cpp
    ...
    named PlayerControl.pch and a precompiled types (PCT) file named stdafx.obj.

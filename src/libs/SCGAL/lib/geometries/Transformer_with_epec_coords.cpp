...
const std::string Transformer_with_epec_coords::s_tag =
  "TransformerWithEpecCoordinates";

//! The node prototype.
Container_proto* Transformer_with_epec_coords::s_prototype(nullptr);

//! Register to the container factory.
REGISTER_TO_FACTORY(Transformer_with_epec_coords,
                    "Transformer_with_epec_coords");

//! \brief initializes the node prototype.
void Transformer_with_epec_coords::init_prototype()
{
...
void Transformer_with_epec_coords::delete_prototype()
{
  delete s_prototype;
  s_prototype = nullptr;
}
...
Container_proto* Transformer_with_epec_coords::get_prototype()
{
  if (!s_prototype) Transformer_with_epec_coords::init_prototype();
  return s_prototype;
}

//! Sets the attributes of the object extracted from the VRML or X3D file.
void Transformer_with_epec_coords::set_attributes(Element* elem)
{ Coord_transformer::set_attributes(elem); }

//! \brief applies the transformation.
void Transformer_with_epec_coords::apply()
{

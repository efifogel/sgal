...
void Torus_renderer::operator()(Draw_action* action)
{ m_torus.draw(action); }

//! \brief constructor.
Colored_torus_renderer::
Colored_torus_renderer(const Vector4f& color) : m_color(color) {}

//! \brief draws the torus.
void Colored_torus_renderer::operator()(Draw_action* action)
{
  glColor4fv((float*)&m_color);
  Torus_renderer::operator()(action);
}

//! \brief draws the torus.
void Stencil_torus_renderer::operator()(Draw_action* action)
{
...
//! \brief draws an arrangement on torus vertex as a disc.
...
//! \brief draws an arrangement on torus vertex.
...
//     draw_disc_vertex_on_torus(action, center, radius, delta_angle);
//     break;
...
//! \brief draws an arrangement on torus edge as a strip.
...
//! \brief draws an arrangement on torus edge.
...
//     draw_strip_edge_on_torus(action, source, target, normal,
...
//     draw_strip_edge_on_torus(action, new_source, new_target, normal,
...
//! \brief draws an arrangement on torus face.

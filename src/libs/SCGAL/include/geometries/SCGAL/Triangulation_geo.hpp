...
public:
  ...
  /*! Constructor */
  Triangulation_geo(Boolean proto = SGAL_FALSE);

  /*! Destructor */
  ~Triangulation_geo();

  /*! Construct the prototype */
  static Triangulation_geo * prototype() { return new Triangulation_geo(SGAL_TRUE); }
...
private:
  ...
  SGAL::Coord_array * m_coord_array;

  /*! A temporary place holder for the color set */
  SGAL::Color_array * m_color_array;
...
protected:
  ...
  /*! Should the representation be cleaned? */
  Boolean is_dirty() const { return m_dirty; }
  
  /*! \brief marks the object as not initialized */
  void coord_changed(SGAL::Field_info * field_info);

  /*! \brief sets the coordinate set */
  void set_coord_array(SGAL::Coord_array * coord_array);

  /*! \brief obtains the coordinate set */
  SGAL::Coord_array * get_coord_array() const;

  /*! \brief sets the coordinate set */
  void set_color_array(SGAL::Color_array * color_array);
  
  /*! \brief obtains the color set */
  SGAL::Color_array * get_color_array() const;
 ...
 */
inline void Triangulation_geo::set_coord_array(SGAL::Coord_array * coord_array)
{
  //! \todo I donth think we should delete here!
 ...
 */
inline SGAL::Coord_array * Triangulation_geo::get_coord_array() const
{
...
/*! Set the color set
 */
inline void Triangulation_geo::set_color_array(SGAL::Color_array * color_array)
{
  //! \todo I donth think we should delete here!
  if (m_color_array) delete m_color_array;
  m_color_array = color_array;
}

/*! Obtain the color set
 */
inline SGAL::Color_array * Triangulation_geo::get_color_array() const
{

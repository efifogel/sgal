...
#ifndef SGAL_ARRANGEMENT_ON_SPHERE_SIM_GEO_HPP
#define SGAL_ARRANGEMENT_ON_SPHERE_SIM_GEO_HPP
 ...
 */
class SGAL_CLASSDEF Arrangement_on_sphere_sim_geo :
  public Agent, 
...
public:
  /*! Constructor */
  Arrangement_on_sphere_sim_geo(Boolean proto = SGAL_FALSE);
  ...
  { return new Arrangement_on_sphere_sim_geo(SGAL_TRUE); }

...
#ifndef SCGAL_ARRANGEMENT_ON_SPHERE_GEO_HPP
#define SCGAL_ARRANGEMENT_ON_SPHERE_GEO_HPP
 ...
 * great circles embeded on a sphere.
 */
class SGAL_SCGAL_DECL Arrangement_on_sphere_geo :
...
public:
  /*! Constructor. */
  Arrangement_on_sphere_geo(Boolean proto = false);

...
public:
  ...
  Boolean* draw_aos_unfolded_handle(const Field_info*)
  { return &m_draw_aos_unfolded; }
  ...
  Vector3f* aos_edge_color1_handle(const Field_info*)
  { return &m_aos_edge_color[0]; }
  Vector3f* aos_edge_color2_handle(const Field_info*)
  { return &m_aos_edge_color[1]; }
  Cgm_node_array* cgm_nodes_handle(const Field_info*)
  { return &m_cgm_nodes; }
  //@}

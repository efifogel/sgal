...
public:
  ...
  /*! Constructor */
  Nef_gaussian_map_geo(Boolean proto = SGAL_FALSE);
  ...
  { return new Nef_gaussian_map_geo(SGAL_TRUE); }
  ...
  virtual void set_attributes(SGAL::Element * elem, SGAL::Scene_graph * sg);

  /*! Initialize the node prototype */
  virtual void init_prototype();

  /*! \brief delete the node prototype */
  virtual void delete_prototype();

  /*! \brief obtain the node prototype */
...
private:
  ...
  /*! The scale of the radius of the geometry that represents a marked vertex */
...
protected:
  ...
  virtual bool is_empty() const { return SGAL_FALSE; }
  ...
  /*! Draws the dual marked vertex, that is a face */

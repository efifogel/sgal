...
class Comp_rotation_interpolator : 
...
public:
  /*! Constructor */
  Comp_rotation_interpolator(Boolean interpolate_flag = true, Boolean proto = SGAL_FALSE);
  ...
  { return new Comp_rotation_interpolator(SGAL_FALSE, SGAL_TRUE); }

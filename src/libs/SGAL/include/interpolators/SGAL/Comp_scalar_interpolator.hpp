...
class Comp_scalar_interpolator : 
...
public:
  /*! Constructor */
  Comp_scalar_interpolator(Boolean interpolate_flag = true, Boolean proto = SGAL_FALSE);
  ...
  { return new Comp_scalar_interpolator(SGAL_FALSE, SGAL_TRUE); }

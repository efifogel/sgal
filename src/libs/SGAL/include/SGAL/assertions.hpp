...
#  define SGAL_assertion(EX) \
  ((EX) ? (static_cast<void>(0)): \
   ::SGAL::assertion_fail(# EX , __FILE__, __LINE__, 0))
...
#  define SGAL_precondition(EX) \
  ((EX) ? (static_cast<void>(0)): \
   ::SGAL::precondition_fail(# EX , __FILE__, __LINE__, 0))
...
#  define SGAL_postcondition(EX) \
  ((EX) ? (static_cast<void>(0)): \
   ::SGAL::postcondition_fail(# EX , __FILE__, __LINE__, 0))
...
#  define SGAL_warning(EX) \
  ((EX) ? (static_cast<void>(0)): \
   ::SGAL::warning_fail(# EX , __FILE__, __LINE__, 0))

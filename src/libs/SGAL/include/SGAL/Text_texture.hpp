...
public:
  ...
  /// \name field handlers
  //@{
  std::string* _handle(const Field_info*) { return &m_text; }
  Vector3f* _handle(const Field_info*) { return &m_color; }
  std::string* _handle(const Field_info*) { return &m_font; }
  Int* _handle(const Field_info*) { return &m_font_size; }
  Boolean* _handle(const Field_info*) { return &m_bold; }
  Boolean* _handle(const Field_info*) { return &m_italic; }
  Boolean* _handle(const Field_info*) { return &m_antialias; }
  //@}

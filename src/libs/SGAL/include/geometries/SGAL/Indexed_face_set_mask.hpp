...
#define SGAL_FSNO_FINO_FAPV_TENO_MOPO_VANO                                    \
  SGAL_SET(SGAL_BO_FRAG_SOURCE,SGAL_BO_FRAG_SOURCE_,FS_NORMAL,                \
    SGAL_SET(SGAL_BO_FRAG_INDEXED,SGAL_BO_FRAG_INDEXED_,0,                    \
      SGAL_SET(SGAL_BO_FRAG_ATTACHMENT,SGAL_BO_FRAG_ATTACHMENT_,AT_PER_VERTEX,\
...
#define SGAL_FSNO_FINO_FAPT_TENO_MOPO_VANO                                    \
  SGAL_SET(SGAL_BO_FRAG_SOURCE,SGAL_BO_FRAG_SOURCE_,FS_NORMAL,                \
    SGAL_SET(SGAL_BO_FRAG_INDEXED,SGAL_BO_FRAG_INDEXED_,0,                    \
      SGAL_SET(SGAL_BO_FRAG_ATTACHMENT,SGAL_BO_FRAG_ATTACHMENT_,AT_PER_PRIMITIVE,\
        SGAL_SET(SGAL_BO_TEXTURE_ENABLED,SGAL_BO_TEXTURE_ENABLED_,0,          \
          SGAL_SET(SGAL_BO_PRIM_TYPE,SGAL_BO_PRIM_TYPE_,PT_POLYGONS,          \
            SGAL_SET(SGAL_BO_VERTEX_ARRAY,SGAL_BO_VERTEX_ARRAY_,0,0x0))))))
...
#define SGAL_FSCO_FINO_FAPM_TENO_MOPO_VANO                                    \
  SGAL_SET(SGAL_BO_FRAG_SOURCE,SGAL_BO_FRAG_SOURCE_,FS_COLOR,                 \
    SGAL_SET(SGAL_BO_FRAG_INDEXED,SGAL_BO_FRAG_INDEXED_,0,                    \
      SGAL_SET(SGAL_BO_FRAG_ATTACHMENT,SGAL_BO_FRAG_ATTACHMENT_,AT_PER_MESH,  \
        SGAL_SET(SGAL_BO_TEXTURE_ENABLED,SGAL_BO_TEXTURE_ENABLED_,0,          \
          SGAL_SET(SGAL_BO_PRIM_TYPE,SGAL_BO_PRIM_TYPE_,PT_POLYGONS,          \
            SGAL_SET(SGAL_BO_VERTEX_ARRAY,SGAL_BO_VERTEX_ARRAY_,0,0x0))))))

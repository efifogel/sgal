...
#ifndef SGAL_EPIC_COORD_ARRAY_3D_HPP
#define SGAL_EPIC_COORD_ARRAY_3D_HPP
...
class SGAL_SGAL_DECL Epic_coord_array_3d : public Coord_array {
public:
  typedef std::vector<Epic_point_3>                     Exact_point_vector;
  typedef Exact_point_vector::iterator                  Exact_point_iter;
  typedef Exact_point_vector::const_iterator            Exact_point_const_iter;

  typedef std::vector<Epic_point_3>::iterator           iterator;
  typedef std::vector<Epic_point_3>::const_iterator     const_iterator;
   ...
   */
  Epic_coord_array_3d(Boolean proto = false);

  /*! Construct.
   * \param[in] n the initial size of the array.
   */
  Epic_coord_array_3d(Size n);

  /*! Destruct. */
  virtual ~Epic_coord_array_3d();

  /* Construct the prototype. */
  static Epic_coord_array_3d* prototype();
   ...
   */
  Epic_point_3& operator[](Uint n);

  /*! Array indexing operator.
   */
  const Epic_point_3& operator[](Uint n) const;

  /*! Inserts a new element at the end.
   */
  void push_back(const Epic_point_3& p);
...
//! \brief destruct.
inline Epic_coord_array_3d::~Epic_coord_array_3d() { clear(); }

//! \brief constructs the prototype.
inline Epic_coord_array_3d* Epic_coord_array_3d::prototype()
{ return new Epic_coord_array_3d(true); }

//! \brief creates a new container of this type (virtual copy constructor).
inline Container* Epic_coord_array_3d::create()
{ return new Epic_coord_array_3d(); }

//! \brief obtains the size.
inline Size  Epic_coord_array_3d::size() const { return m_array.size(); }

//! \brief resizes. */
inline void  Epic_coord_array_3d::resize(Size n) { m_array.resize(n); }

//! \brief obtains the number of coordinate dimensions.
inline Size Epic_coord_array_3d::num_coordinates() const { return 3; }

//! \brief obtains the begin iterator.
inline Epic_coord_array_3d::Exact_point_iter Epic_coord_array_3d::begin()
{ return m_array.begin(); }

inline Epic_coord_array_3d::Exact_point_const_iter
Epic_coord_array_3d::begin() const
{ return m_array.begin(); }

//! \brief obtains the pass-the-end iterator.
inline Epic_coord_array_3d::Exact_point_iter Epic_coord_array_3d::end()
{ return m_array.end(); }

inline Epic_coord_array_3d::Exact_point_const_iter Epic_coord_array_3d::end()
  const
{ return m_array.end(); }

//! \brief array indexing operator.
inline Epic_point_3& Epic_coord_array_3d::operator[](Uint n)
{ return m_array[n]; }

//! \brief array indexing operator.
inline const Epic_point_3& Epic_coord_array_3d::operator[](Uint n) const
{ return m_array[n]; }

//! \brief inserts a new element at the end.
inline void Epic_coord_array_3d::push_back(const Epic_point_3& p)
{ m_array.push_back(p); }

//! \brief obtains the tag (type) of the container.
inline const std::string& Epic_coord_array_3d::get_tag() const
{ return s_tag; }

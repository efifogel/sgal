...
#ifndef SGAL_EPEC_PLANE_ARRAY_HPP
#define SGAL_EPEC_PLANE_ARRAY_HPP
...
class SGAL_SGAL_DECL Epec_plane_array : public Container {
public:
  typedef std::vector<Epec_plane_3>                     Exact_plane_vector;
  ...
  /*! Constructor. */
  Epec_plane_array(Boolean proto = false);

  /*! Constructor. */
  Epec_plane_array(Uint n);

  /*! Destructor. */
  virtual ~Epec_plane_array();
  ...
  Epec_plane_3& operator[](Uint n);

  /*! Array indexing operator. */
  const Epec_plane_3& operator[](Uint n) const;

  /*! Insert a new element at the end. */
  void push_back(const Epec_plane_3& p);

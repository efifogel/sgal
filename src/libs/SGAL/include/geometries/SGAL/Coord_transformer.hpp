...
public:
  ...
  /*! Constructor */
  Coord_transformer(Boolean proto = SGAL_FALSE);
  
  /* Construct the prototype */
  static Coord_transformer * prototype()
  { return new Coord_transformer(SGAL_TRUE); }

  /*! Clone */
  virtual Container * clone() { return new Coord_transformer(); }
  ...
  void set_reflect(bool reflect) { m_reflect = reflect; }

  /*! Obtain the reflection indication-flag */
  bool get_reflect() const { return m_reflect; }

  /*! Set the coordinate-set node */
  void set_coord_array(Coord_array * coord) { m_coord_array = coord; }

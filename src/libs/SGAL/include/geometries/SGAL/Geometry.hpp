...
public:
  ...
  virtual Boolean are_generated_color() const { return false; }
  ...
  /*! Set texture coordinates generated by the geometry. */
  void set_generated_tex_coord(Boolean flag) { m_generated_tex_coord = flag; }  

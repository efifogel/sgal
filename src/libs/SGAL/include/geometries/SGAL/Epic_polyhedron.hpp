...
/*! \file
 * Defines the type Epic_polyhedron, which is a polyhedral surface
...
#ifndef SGAL_EPIC_POLYHEDRON_HPP
#define SGAL_EPIC_POLYHEDRON_HPP
...
typedef CGAL::Polyhedron_3<Epic_kernel, Epic_polyhedron_items> Epic_polyhedron;

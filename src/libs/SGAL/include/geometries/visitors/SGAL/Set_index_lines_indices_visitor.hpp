...
#ifndef SGAL_SET_INDEX_LINES_INDICES_VISITOR_HPP
#define SGAL_SET_INDEX_LINES_INDICES_VISITOR_HPP
...
/*! Set index lines indices visitor. */
class Set_index_lines_indices_visitor : public boost::static_visitor<> {
private:
  size_t m_address;
  Index_type m_value;

public:
  Set_index_lines_indices_visitor(size_t address, Index_type value) :

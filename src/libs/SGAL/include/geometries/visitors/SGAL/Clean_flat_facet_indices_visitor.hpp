...
#ifndef SGAL_CLEAN_FLAT_FACET_INDICES_VISITOR_HPP
#define SGAL_CLEAN_FLAT_FACET_INDICES_VISITOR_HPP
...
class Clean_flat_facet_indices_visitor : public boost::static_visitor<> {
public:
  std::vector<Int32>& m_indices;

  Clean_flat_facet_indices_visitor(std::vector<Int32>& indices) :
    m_indices(indices)
  {}

...
#ifndef SGAL_CLEAR_LINES_INDICES_VISITOR_HPP
#define SGAL_CLEAR_LINES_INDICES_VISITOR_HPP
...
/*! Clear lines indices visitor. */
class Clear_lines_indices_visitor : public boost::static_visitor<> {
public:
...
private:
  ...
  void operator()(Polyline_indices& indices, Identity<Polyline_indices>) const
  {

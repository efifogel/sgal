  ...
  m_dirty_center(true)
{
  ...
  for (int i = 0; i < NUM_DRAWS; ++i)
    draws[i] = &Boundary_set::draw_invalid;
  ...
  // Triangles:
  // Texture disabled:
  draws[FSNO_FINO_FAPV_TENO_MOTR_VAYE] = &Boundary_set::draw_FAPV_VAYE;
  draws[FSCO_FINO_FAPV_TENO_MOTR_VAYE] = &Boundary_set::draw_FAPV_VAYE;
  draws[FSNO_FIYE_FAPV_TENO_MOTR_VAYE] = &Boundary_set::draw_FAPV_VAYE;
  draws[FSCO_FIYE_FAPV_TENO_MOTR_VAYE] = &Boundary_set::draw_FAPV_VAYE;
  ...
  // Quads:
  // Texture disabled:
  draws[FSNO_FINO_FAPV_TENO_MOQU_VAYE] = &Boundary_set::draw_FAPV_VAYE;
  draws[FSCO_FINO_FAPV_TENO_MOQU_VAYE] = &Boundary_set::draw_FAPV_VAYE;
  draws[FSNO_FIYE_FAPV_TENO_MOQU_VAYE] = &Boundary_set::draw_FAPV_VAYE;
  draws[FSCO_FIYE_FAPV_TENO_MOQU_VAYE] = &Boundary_set::draw_FAPV_VAYE;
...
inline Boolean Boundary_set::are_generated_color()
{ return (m_generated_color); }

//! \brief determines whether texture coordinates are generated by the geometry.
inline Boolean Boundary_set::are_generated_tex_coord()

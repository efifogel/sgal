...
Container_proto * Remote_keys::s_prototype(nullptr);
  ...
  for (auto ai = elem->str_attrs_begin(); ai != elem->str_attrs_end(); ++ai) {
    ...
    if (name == "btn1") {
      ...
      if (pTemp)
        ...
        MessageBox(nullptr,"Error::Invalid attribue",
...
EKeyAction* Remote_keys::CreateKeyAction(String str)
{
  ...
  if (vals[0] == "translate") {
    if (vals.size() != 4)
      return res;
    res = new EKATranslate(atoi(vals[1].c_str()), atoi(vals[2].c_str()),
                           atoi(vals[3].c_str()));
  }
  else if (vals[0] == "rotate") {
    if (vals.size() != 5)
      return res;
    res = new EKARotate(atoi(vals[1].c_str()), atoi(vals[2].c_str()),
    ...
    if (vals.size() != 7)
      return res;
    res = new EKASwitchFields(vals[1], vals[2], vals[3],
...
EKeyAction* Remote_keys::get_keyAction(String str)
{
  ...
  if (keyIter != m_keyMap.end()) res = (*keyIter).second;
  return res;
}

...
#include "Item_primitive.h"

/*! calculates how much memory in bytes is required for an image */
#define SGAL_SIZE_IN_BYTES(bits) (((bits) + 7) >> 3)
...
public:
  ...
  /** Return a pointer to the pixels array. */
  void * get_pixels() { return m_pixels; }

  /** Set the pointer to the pixels/ */

...
Gl_mapper::Gl_mapper()
{
  ...
  m_gl_token_names[GL_DEPTH_ATTACHMENT] = "GL_DEPTH_ATTACHMENT";
  m_gl_token_names[GL_STENCIL_ATTACHMENT] = "GL_STENCIL_ATTACHMENT";
  m_gl_token_names[GL_FRAMEBUFFER] = "GL_FRAMEBUFFER";
  m_gl_token_names[GL_RENDERBUFFER] = "GL_RENDERBUFFER";
  m_gl_token_names[GL_RENDERBUFFER_WIDTH] = "GL_RENDERBUFFER_WIDTH";
  m_gl_token_names[GL_RENDERBUFFER_HEIGHT] = "GL_RENDERBUFFER_HEIGHT";
  m_gl_token_names[GL_RENDERBUFFER_INTERNAL_FORMAT] = "GL_RENDERBUFFER_INTERNAL_FORMAT";
  m_gl_token_names[GL_STENCIL_INDEX1] = "GL_STENCIL_INDEX1";
  m_gl_token_names[GL_STENCIL_INDEX4] = "GL_STENCIL_INDEX4";
  m_gl_token_names[GL_STENCIL_INDEX8] = "GL_STENCIL_INDEX8";
  m_gl_token_names[GL_STENCIL_INDEX16] = "GL_STENCIL_INDEX16";
  m_gl_token_names[GL_RENDERBUFFER_RED_SIZE] = "GL_RENDERBUFFER_RED_SIZE";
  m_gl_token_names[GL_RENDERBUFFER_GREEN_SIZE] = "GL_RENDERBUFFER_GREEN_SIZE";
  m_gl_token_names[GL_RENDERBUFFER_BLUE_SIZE] = "GL_RENDERBUFFER_BLUE_SIZE";
  m_gl_token_names[GL_RENDERBUFFER_ALPHA_SIZE] = "GL_RENDERBUFFER_ALPHA_SIZE";
  m_gl_token_names[GL_RENDERBUFFER_DEPTH_SIZE] = "GL_RENDERBUFFER_DEPTH_SIZE";
  m_gl_token_names[GL_RENDERBUFFER_STENCIL_SIZE] = "GL_RENDERBUFFER_STENCIL_SIZE";
  m_gl_token_names[GL_FRAMEBUFFER_INCOMPLETE_MULTISAMPLE] = "GL_FRAMEBUFFER_INCOMPLETE_MULTISAMPLE";
  m_gl_token_names[GL_MAX_SAMPLES] = "GL_MAX_SAMPLES";
  m_gl_token_names[GL_INDEX] = "GL_INDEX";
  m_gl_token_names[GL_TEXTURE_LUMINANCE_TYPE] = "GL_TEXTURE_LUMINANCE_TYPE";
  m_gl_token_names[GL_TEXTURE_INTENSITY_TYPE] = "GL_TEXTURE_INTENSITY_TYPE";
#endif
}

...
template <>
const std::map<int, Dxf_view_table::Table_entry_member>
Dxf_view_table::s_entry_members = {
  ...
  {112, {&Dxf_view_entry::m_ucs_y_axis, 1, 0}},
  {122, {&Dxf_view_entry::m_ucs_y_axis, 1, 1}},
  {132, {&Dxf_view_entry::m_ucs_y_axis, 1, 2}},

...
typedef Dxf_record_wrapper<Dxf_ellipse_edge>  Dxf_ellipse_edge_wrapper;
...
//! Record handlers
template <>
const std::map<int, Dxf_ellipse_edge_wrapper::Record_handler_type>
Dxf_ellipse_edge_wrapper::s_record_handlers = {};

...
Dxf_acdbplaceholder_object_wrapper::s_record_members = {
};

//! Record handlers
template <>
const std::map<int, Dxf_acdbplaceholder_object_wrapper::Record_handler_type>
Dxf_acdbplaceholder_object_wrapper::s_record_handlers = {};

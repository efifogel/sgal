    ...
    function parseV2(lines, scene) {
      ...
      function parseNode(data, parent) {
        ...
        if (data.nodeType === "AmbientLight") {
          ...
          var skyGeometry = new THREE.SphereBufferGeometry(
            radius,
            segments,
            segments
          );
          ...
          if (data.nodeType === "Box") {
            ...
            parent.geometry = new THREE.CylinderBufferGeometry(
              data.radius,
              data.radius,
              data.height
            );

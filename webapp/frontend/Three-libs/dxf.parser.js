      ...
      2: [
        function(require, module, exports) {
          ...
          function parseBoolean(str) {
            ...
            throw TypeError(
              "String '" + str + "' cannot be cast to Boolean type"
            );
          }
              ...
              while (curr.value !== "EOF") {
                ...
                if (groupIs(0, "TABLE")) {
                  ...
                  if (tableDefinition) {
                    ...
                    tables[
                      tableDefinitions[curr.value].tableName
                    ] = parseTable();
                    log.debug("}");
                  } else {
